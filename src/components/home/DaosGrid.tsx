  ...
  return (
    <section className="sectionDaosGrid">
      ...
      @media (max-width:925px){
        ...
        .div1-1 { grid-area: 1 / 1 / 10 / 7; height: 350px; }
        .div2-1 { grid-area: 2 / 9 / 11 / 13; height: 350px; }

        .div1-2 { grid-area: 1 / 1 / 10 / 7; height: 350px; }
        .div2-2 { grid-area: 2 / 9 / 11 / 13; height: 350px; }
      ...
      @media (min-width:925px){
        ...
        .div1-1 { grid-area: 2 / 1 / 11 / 7; height: 450px; }
        .div2-1 { grid-area: 1 / 9 / 10 / 13; }
        ...
        .div1-2 { grid-area: 1 / 1 / 10 / 7; height: 450px; }
        .div2-2 { grid-area: 2 / 9 / 11 / 13; }
