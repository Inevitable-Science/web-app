...
const Footer: React.FC = () => {
  return (
    <footer className="flex h-screen w-full flex-col bg-[url('/assets/img/footer.webp')] bg-cover bg-center px-12 py-8 font-light [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_100%)]">
      {/* CENTERED SECTION */}
