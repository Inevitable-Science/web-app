...
export const DaoData: FC<TreasuryPreview> = ({ data }) => {
  ...
  return (
    <section className="flex flex-col gap-6 my-6">
      <div className="bg-grey-450 p-[12px] rounded-2xl">
        ...
        <Button variant="link" className="h-6 pl-2 flex items-center gap-1.5 font-normal uppercase transition-[gap] duration-150 hover:gap-3">
          Treasury Stats
        ...
        <div className="flex flex-col gap-2 mb-2">
          <div className="grid grid-cols-2 gap-3">
            <div className="background-color p-[16px] rounded-2xl">
              ...
              <p className="text-muted-foreground font-light uppercase">TKN Price</p>
            </div>
            <div className="background-color p-[16px] rounded-2xl">
              {data ? (
              <h4 className="text-xl mb-0.5 tracking-wider">
