...
export function Footer() {
  return (
    <div className="relative z-[-1] -mt-[240px] flex h-[600px] w-full items-end bg-[url('/assets/img/layout/ivx/ivx_footer_image.webp')] bg-cover bg-center px-12 pb-[144px] pt-8 font-light mask-[linear-gradient(to_bottom,transparent_0%,black_10%,black_100%)]">
