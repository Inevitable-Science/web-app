...
const slides: SlideType[] = [
  {
    ...
    description: "Founder of CryoDAO, HydraDAO, Cryopets, and the American Biostasis Foundation.",
  ...
  },
  {
    ...
    name: "Eli Mohamad",
    description: "Founder of ErectusDAO, CryoDAO, and HydraDAO. Co-founded X-Therma and the Organ Preservation Alliance.",
  ...
  },
  {
    ...
    name: "Austin Lynch",
    description: "Founder of HydraDAO, Steward of CryoDAO, Head of Member Care at Cryopets.",
  ...
  },
  {
    ...
    description: "Founder of Tomorrow Bio, the European Biostasis Foundation, CryoDAO, and HydraDAO.",
...
const TeamComponent: React.FC = () => {
  return (
    <section>
      ...
      <div className="flex flex-wrap gap-4 justify-center mt-48 lg:grid lg:grid-cols-[repeat(auto-fit,minmax(200px,1fr))]">
        {slides.map((slide, index) => (
          <div
            key={index}
            className="flex min-w-[180px] max-w-[360px] sm:max-w-[250px] lg:max-w-[500px] w-full"
          >
