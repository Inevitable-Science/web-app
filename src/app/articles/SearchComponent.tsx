      ...
      <AnimatePresence>
        {isOpen && (
          <motion.input
            ...
            className="background-color border-grey-500 placeholder:text-muted-foreground focus:border-grey-100 absolute left-[-200px] h-10 w-48 rounded-full border px-3 text-sm font-light ring-0 outline-hidden focus:ring-0"
