      ...
      <AnimatePresence>
        {isOpen && (
          <motion.input
            ...
            className="background-color absolute left-[-200px] h-10 w-48 rounded-full border border-grey-500 px-3 text-sm font-light outline-hidden ring-0 placeholder:text-muted-foreground focus:border-grey-100 focus:ring-0"
