...
export default function Ecosystem() {
  return (
    <div>
      <div className="absolute inset-0 bg-[url('/assets/img/ecosystem_backdrop.png')] bg-cover w-full bg-center z-[-1]"></div>
      ...
      <section className="ctWrapper mt-[140px]">
        ...
        <div className="flex flex-col gap-[12px]">
          <div className="grid gap-3 grid-cols-[repeat(auto-fit,minmax(200px,1fr))]">
            <div className="bg-grey-450 flex flex-col gap-[12px] p-[12px] rounded-2xl uppercase">
