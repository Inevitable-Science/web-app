...
export type LoansByAccountQuery = { loans: { items: Array<{ borrowAmount: any, collateral: any, prepaidDuration: number, projectId: number, terminal: string, token: string, chainId: number, createdAt: number }> } };
...
export type LoansDetailsByAccountQuery = { loans: { items: Array<{ borrowAmount: any, collateral: any, prepaidDuration: number, createdAt: number, projectId: number, terminal: string, token: string, chainId: number, id: any }> } };
...
export type ProjectQuery = { project: { projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string, owner: string, volume: any, paymentsCount: number } | null };
...
export type SuckerGroupQuery = { suckerGroup: { id: string, tokenSupply: any } | null };
