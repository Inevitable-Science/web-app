...
export type ProjectQuery = { project: { projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string, owner: string, volume: any, paymentsCount: number, tokenSupply: any } | null };
